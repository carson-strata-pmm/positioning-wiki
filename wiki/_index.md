...
| [[concepts/messaging-hierarchy]] | The standard Strata architecture: POV > Hero Problem > Pain Pillars > Solution > Value Pillars > Outcomes > Proof. Covers the 3-pillar pattern and document types. | Avoca, Eudia, Agency, TeamOhana, Unity Industry, Unity Games |
...
|--------|-------------|--------------|-----------------|
| [[clients/avoca]] | "Your growth is hitting a ceiling" | Messaging Framework, Co-founder Interview, Messaging Playground | Head-to-head |
| [[clients/agency]] | "The Customer Value Paradox" | Messaging Framework, Narrative Thinking | Category creator |
| [[clients/eudia]] | "The speed-to-risk ratio" | CLO POV (x2), CLO Framework, ALF POV, ALF Framework, Messaging Map | Category creator (dual) |
| [[clients/brightedge]] | "Discoverability in the AI era" | Platform Messaging Framework, Category Naming Exploration | Category redefiner |
| [[clients/general-legal]] | "The Scarcity Constraint" | Messaging Framework | Category redefiner |
| [[clients/jane]] | "The dual responsibility" | Messaging Framework (final), Framework v2, Messaging Playground | Head-to-head |
