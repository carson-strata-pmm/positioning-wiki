...
- **Strong (4-5):** A hero problem that names the structural reason elite legal expertise is artificially scarce -- indicting the model that created the scarcity, not the scarcity itself as a symptom. (See General Legal's "The Scarcity Constraint" -- names the architectural cause, not the felt effect.)
...
- **Are there exactly three pillars?** Three is the standard. Four pillars can work for identity-burden hero problems (see Jane's "dual responsibility" framework), but this is the exception and should be justified.
...
- **Strong (5/5):** TeamOhana's three pillars -- "Untrusted data" (visibility), "Lack of control" (governance), "Wasted time" (productivity) -- decompose the hero problem along completely different dimensions. Each has a distinct cause stack and quantified consequences. No overlap. Clean upstream-to-downstream sequence.
- **Weak (2/5):** Snappy's Pillar 1 restates the hero problem ("ad hoc gifting") rather than decomposing it into a distinct dimension. Two pillars describe capacity problems with different labels. Consequences are vague throughout.
...
- **Strong (5/5):** Avoca's framework targets the owner-operator (CEO/GM of a home services business) and uses their language throughout -- "book more jobs," "missed calls," "your front office." A VP of Marketing at a SaaS company would find this messaging irrelevant. That's the point.
...
- **Strong (5/5):** "Every matter strengthens a living knowledge base of company context, legal history, and risk preferences -- so advice becomes more precise with every interaction." Specific mechanism (learning from each matter), specific outcome (increasing precision), un-copyable (requires a specific product architecture to deliver).
...
**Weak (Snappy):** Hero problem is "ad hoc gifting." Pillar 1 is "ad hoc gifting." This isn't decomposition -- it's repetition. The pillar should name a *dimension* of the hero problem, not the hero problem itself.

**Strong (TeamOhana):** Hero problem is "The Headcount Headache." Pillar 1 is "Untrusted data" -- one specific dimension (data quality) of the broader problem.

### Mistake 3: Value Pillars Are Abstract Labels

**Weak (Snappy):** "Expertise," "Scale," "Delight" -- single-word abstractions that could describe any B2B product. These aren't value statements; they're categories.

**Strong (Avoca):** "Book more jobs," "Scale your front office," "Get visibility into every call" -- specific outcomes in the buyer's language that tell the buyer exactly what they get.
...
**Strong (Avoca):** "Per-call ROI tracking," "<3 second answer time." These are verifiable in a demo and specific to the product's architecture. A competitor would have to build different technology to match these claims.
...
**Strong (Agency):** The competitive framing indicts the human-led service model as structurally incapable of scaling customer intimacy -- more people means more handoffs means worse experience, by design. The enemy isn't a competitor; it's the operating model.

### Mistake 6: Consequences Are Unquantified

**Weak (Snappy):** "Gifts don't land," "Inequitable experiences." These are real but vague. How much do they cost? How often do they happen? What's the business impact?

**Strong (TeamOhana):** "$294K average in unapproved headcount costs," "75% of time wasted on manual processes." These numbers make the invisible visible and create procurement-ready urgency.
...
**Strong (Eudia):** Recognized the CLO and ALF audiences needed separate frameworks entirely. One hero problem space, two completely different pillar structures, buyer languages, and proof points.
...
- [[clients/avoca]] -- scores highest across Dimensions 3 (buyer specificity) and 4 (clarity & specificity)
- [[clients/teamohana]] -- scores highest on Dimension 2 (pillar construction) -- cleanest decomposition in the corpus
- [[clients/agency]] -- scores highest on Dimension 5 (competitive clarity) -- strongest architectural enemy framing
- [[clients/eudia]] -- demonstrates how to handle frameworks that serve multiple buyers (separate documents)
- [[clients/general-legal]] -- strong hero problem and competitive clarity; structural indictment of the billable hour model
- [[clients/snappy]] -- lowest scores across Dimensions 1-4; useful as a calibration baseline
