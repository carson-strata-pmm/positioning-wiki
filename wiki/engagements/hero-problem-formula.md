# Hero Problem Formula

_A universal framework for naming and framing hero problems, derived from cross-client analysis_

## The Formula

Every strong hero problem in the Strata corpus follows this structure:

```
HERO PROBLEM = Named Tension + Structural Cause + Hidden Consequence
```

**Named Tension:** A compact, memorable label (ideally "The [Noun] [Tension Word]") that compresses a complex trade-off into something the buyer instantly recognizes.

**Structural Cause:** The reason the problem can't be solved by trying harder, hiring more, or using existing tools. The architecture itself -- the operating model, the tool landscape, the market structure -- creates the tension.

**Hidden Consequence:** A specific, preferably quantifiable cost that the buyer has been tolerating because they assumed it was the cost of doing business.

---

## The Three-Layer Structure

Every hero problem, regardless of industry, operates on three layers:

### Layer 1: A named tension the buyer lives with daily
The problem is always a forced trade-off between two things the buyer cares about:
...
The problem must be architectural, not incidental:
...
**How to apply:** Listen in discovery for moments where the buyer describes investing more in something and getting diminishing or negative returns. The paradox names the inversion.

**Best for:** Sophisticated buyers, category creators, situations where the current approach is actively counterproductive.
...
**How to apply:** Map the buyer's workflow and identify where handoffs between teams, tools, or processes create friction. The gap exists at the seam between two things that should be unified.

**Best for:** Products that bridge two existing categories, cross-functional workflows, category creators and redefininers.
...
**How to apply:** During discovery, ask the buyer to estimate costs they probably haven't calculated: time lost per process, revenue from missed opportunities, cost of errors. The gap between their estimate and reality is the hidden cost.

**Best for:** Operational buyers (VP Ops, Controller, CFO), head-to-head and category creators alike.
...
**How to apply:** Identify what the buyer wishes they had more access to (expertise, data, capacity) and trace the scarcity back to a structural cause -- a business model, a technology limitation, a market structure.

**Best for:** Products that democratize access, category redefininers.
...
**How to apply:** Listen for identity language in discovery -- moments where the buyer describes who they want to be vs. who their day forces them to be. The burden names the gap between aspiration and reality.

**Best for:** Owner-operators, solo buyers, personas where professional and personal identity overlap.
...
## How to Apply to a New Engagement

### Step 1: Identify the tension
In discovery interviews, listen for the two things the buyer is forced to trade off. Write them as "X vs. Y." If you can't identify a clear trade-off, you haven't found the hero problem yet.

### Step 2: Validate the structural cause
Ask: why can't the buyer solve this by trying harder? If the answer is "the tools aren't built for this," "the business model creates this," or "the market is structured this way," you have a structural cause. If the answer is "they just need to be more disciplined," the problem isn't structural enough.

### Step 3: Quantify the hidden consequence
Find the number the buyer doesn't know. Hours lost, dollars wasted, opportunities missed, risk unmanaged. The specific number is more important than the big number -- $294K in unapproved headcount is more powerful than "millions in waste."

### Step 4: Select the archetype
